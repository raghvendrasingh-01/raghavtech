...
const About = () => {
  return (
    <>
      ...
      >
        <a
          href="https://github.com/raghvendrasingh-01"
          target="_blank"
          rel="noopener noreferrer"
          className="w-12 h-12 rounded-full bg-tertiary flex items-center justify-center hover:bg-purple-600 transition-colors"
        >
